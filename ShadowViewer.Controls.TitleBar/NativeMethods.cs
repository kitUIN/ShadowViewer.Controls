...
internal static class NativeMethods
{
    ...
    {
        return IntPtr.Size is 8 ? GetWindowLongPtr(hWnd, nIndex) : GetWindowLong(hWnd, nIndex);
    }
    ...
    {
        return IntPtr.Size is 8 ? SetWindowLongPtr(hWnd, nIndex, dwNewLong) : SetWindowLong(hWnd, nIndex, dwNewLong);
    }
